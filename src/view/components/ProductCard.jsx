...
const ProductCard = () => {
  return (
       ...
       <div
           ...
           {/* <!-- Image div --> */}
           <div>
               <img src="src/assets/headphone.png" alt="" className="mx-auto
           ...
           <div className="flex flex-col space-y-6">
               ...
               <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
                   ...
                   <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
                       <button
                           className="flex item-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150">
                           <img src="src/assets/weight.png" alt="" className="w-8" />
                           <span>Add to cart</span>
                       </button>

                       <button
                       className="flex item-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150">
                       <img src="src/assets/heart.png" alt="" className="w-8" />
